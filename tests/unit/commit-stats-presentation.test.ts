...
import { CHANGES_COLUMN_CONTENT_WIDTH, CHANGES_COLUMN_START, CHANGES_COLUMN_WIDTH, COMMIT_CONTENT_MIN_WIDTH, TIMELINE_MIN_CONTENT_WIDTH } from '../../webview/src/components/graphMetrics';
