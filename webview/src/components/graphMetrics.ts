 ...
 */
export function changesColumnStartForLayout(layout: Pick<GraphLayout, 'nodes' | 'historyRelations' | 'refMovementRelations' | 'rebaseRelations' | 'cherryPickGroupRelations' | 'rewriteCollapseRelations'>): number {
...
export function timelineContentWidthForLayout(layout: Pick<GraphLayout, 'nodes' | 'historyRelations' | 'refMovementRelations' | 'rebaseRelations' | 'cherryPickGroupRelations' | 'rewriteCollapseRelations'>): number {
...
export function graphWidthForLayout(layout: Pick<GraphLayout, 'nodes' | 'laneWidth'> & Partial<Pick<GraphLayout, 'rowHeight' | 'historyRelations' | 'refMovementRelations' | 'rebaseRelations' | 'cherryPickGroupRelations' | 'rewriteCollapseRelations' | 'historyRelationPaths' | 'refMovementPaths' | 'rebaseRelationPaths' | 'cherryPickGroupPaths' | 'rewriteCollapsePaths'>>): number {
  ...
  const paths = [...(layout.historyRelationPaths ?? []), ...(layout.refMovementPaths ?? []), ...(layout.rebaseRelationPaths ?? []), ...(layout.cherryPickGroupPaths ?? []), ...(layout.rewriteCollapsePaths ?? [])];
